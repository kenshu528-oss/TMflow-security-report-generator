#!/usr/bin/env python3
"""
TMflow Security Report Generator - 建置腳本 v1.0.2.045
按鈕文字國際化修正版
"""
...
def build_executable():
    ...
    print("=" * 60)
    print("TMflow Security Report Generator v1.0.2.045")
    print("按鈕文字國際化修正版 - 建置腳本")
    print("=" * 60)
    print()
...
✅ 按鈕文字國際化修正
   - 報告生成過程中按鈕顯示「Generating...」而非「生成中...」
   - 保持介面一致性，所有按鈕文字統一使用英文
