#!/usr/bin/env python3
"""
TMflow Security Report Generator - 建置腳本 v1.0.2.048
UI 佈局比例修正版 (PanedWindow + 動態調整)
"""
...
def build_executable():
    ...
    print("=" * 60)
    print("TMflow Security Report Generator v1.0.2.048")
    print("UI 佈局比例修正版 (PanedWindow + 動態調整) - 建置腳本")
    print("=" * 60)
    print()
