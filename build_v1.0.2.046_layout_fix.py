#!/usr/bin/env python3
"""
TMflow Security Report Generator - 建置腳本 v1.0.2.046
UI 佈局比例修正版
"""
...
def build_executable():
    ...
    print("=" * 60)
    print("TMflow Security Report Generator v1.0.2.046")
    print("UI 佈局比例修正版 - 建置腳本")
    print("=" * 60)
    print()
...
✅ UI 佈局比例修正
   - 修正視窗放大後左右比例變成 5:5 的問題
   - 使用 grid 佈局維持固定 60:40 比例
   - 響應式設計，無論視窗大小都保持正確比例
