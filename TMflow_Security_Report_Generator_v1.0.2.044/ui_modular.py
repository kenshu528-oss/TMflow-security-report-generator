#!/usr/bin/env python3
"""
TMflow Security Report Generator - 模組化版本 v1.0.2.044
API 連接狀態顯示修正版
"""
...
class ModularTMflowReportGeneratorUI:
    ...
    def setup_window(self):
        """設定主視窗"""
        self.root.title("TMflow Security Report Generator v1.0.2.044")
    ...
    def load_initial_data(self):
        ...
        self.log_message("TMflow Security Report Generator v1.0.2.044")
